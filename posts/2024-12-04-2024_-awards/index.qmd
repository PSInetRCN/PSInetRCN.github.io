...
-   **Most Species Measured:** For datasets including the widest range of species — *Clément Stahl (37 datasets)*
...
-   **Most cross-network coordination:** For sharing data to both Sapfluxnet and Psinet — *Virginia Hernandez-Santana & Rafael Poyatos (5 sites)*
...
-   **Most Field Sites Represented Within Studies:** For datasets collected from the highest number of locations within a broader field site — *Drew Peltier & Kiona Ogle (22 sites)*
